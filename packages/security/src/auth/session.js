...
export class SessionService {
    static DEFAULT_SESSION_DURATION_DAYS = 30;
    static SESSION_TOKEN_LENGTH = 32;
    static MAX_SESSIONS_PER_USER = 10;
    /**
     ...
     */
    static updateLastAccessed(session) {
        return {
            ...session,
     ...
     */
    static extendSession(session, additionalDays = 30) {
     ...
     */
    static invalidateSession(session) {
        return {
            ...session,
            isActive: false,
        };
     ...
     */
    static calculateSessionRiskScore(session, currentIp, currentUserAgent) {
        let score = 0;
        const factors = [];
        // IP address change
     ...
     */
    static shouldRequireReAuth(riskScore) {
