export class OAuthService {
     ...
     */
    static createGoogleConfig(config) {
        return {
            id: 'google',
            name: 'Google',
            type: 'oauth',
     ...
     */
    static createGitHubConfig(config) {
        return {
            id: 'github',
            name: 'GitHub',
            type: 'oauth',
     ...
     */
    static createMicrosoftConfig(config) {
     ...
     */
    static createDiscordConfig(config) {
        return {
            id: 'discord',
            name: 'Discord',
            type: 'oauth',
     ...
     */
    static getProviderBranding(provider) {
        const branding = {
